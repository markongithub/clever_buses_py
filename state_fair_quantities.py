...
#     print(f"current buses by route: {current_buses_by_route}")
    if current_buses_by_route == previous_buses_by_route:
        pass
    else:
        if started_at:
            print(f"{format_time(started_at)} to {format_time(retrieved_at)}: {current_buses_by_route}")
        started_at = retrieved_at
        previous_buses_by_route = current_buses_by_route
